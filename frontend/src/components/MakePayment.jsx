...
function MakePayment(props) {
  ...
  return (
    <div>
      <div>
        <div className="flex justify-between">
          <div className="flex flex-col">
            <div className="text-medium font-black flex gap-2">
              Status:- <h1 className="text-green-400">{messages[4]?.status}</h1>
            </div>
          </div>
      ...
      <Link
        to="/payment"
        className="bg-green-600 w-full text-white py-2 rounded mt-8 flex items-center justify-center"
      >
        Make a Payment
      </Link>
    </div>
