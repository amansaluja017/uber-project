            ...
            <div>
                <div className='flex justify-between'>
                    <div className='flex flex-col'>
                        <div className='text-medium font-black flex gap-2'>Status:- <h1 className='text-orange-400'>{props.ride.status}</h1></div>
                        <div className='text-medium font-black flex gap-2'>Distance:- <h1 className='text-yellow-500'>{props.ride.distance}</h1></div>
                    </div>
