    ...
    <div>
      ...
      <form onSubmit={checkOtp}>
        <div>
          ...
          <Button
            ref={submitButton}
            className="bg-green-700 mt-8 w-full disabled:bg-green-300"
            disabled
          >
            Confirm
          </Button>
          <Button
            ...
            className="bg-red-700 mt-[2%] w-full"
          >
            Cancel
          </Button>
        </div>
      ...
      <div className="inline-block bg-green-500 text-white rounded-full absolute right-7 bottom-10">
        <button
          onClick={() => {
            props.setCaptianChatPanel(true);
          }}
