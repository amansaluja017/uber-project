...
function ConfirmVehcile(props) {
    ...
    if(props.vehicleType === 'motorbike') {
        vehicleType.current.src = 'https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,h_368,w_552/v1649231091/assets/2c/7fa194-c954-49b2-9c6d-a3b8601370f5/original/Uber_Moto_Orange_312x208_pixels_Mobile.png'
        vehicleType.current.alt ='motorbike'
    } else if(props.vehicleType === 'auto') {
        vehicleType.current.src = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsFabRnJZ8deGXJSKA1QjN45920WytRrdFsA&s'
  ...
  return (
    <div>
        ...
        <div className='flex items-center justify-center'>
            <img ref={vehicleType} className='h-[10rem] w-[10rem] object-contain' src="https://www.jaipurcitycab.in/images/car2.png" alt="car" />
        </div>
        ...
        <Button onClick={() => {props.setlookingDriverPanel(true), props.createRide()}} className='bg-green-600 w-full'>Confirm</Button>
    </div>
  )
}
