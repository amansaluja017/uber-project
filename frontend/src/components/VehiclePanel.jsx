...
function VehiclePanel(props) {
  return (
    <div>
        <div onClick={() => {props.setconfirmVehiclePanel(true)}} className='active:outline-2 border-gray-50 w-full mt-10 rounded-2xl flex'>
          <div>
        ...
        <div onClick={() => {props.setconfirmVehiclePanel(true)}} className='active:outline-2 border-gray-50  w-full mt-5 rounded-2xl flex'>
          <div>
