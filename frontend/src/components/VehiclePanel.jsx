...
function VehiclePanel(props) {
  return (
    <div>
      <div
        onClick={() => {
          props.setconfirmVehiclePanel(true), props.selectVehicle("car");
        }}
        className="active:outline-2 border-gray-50 w-full mt-10 rounded-2xl flex items-center"
      >
        <div>
          <img
      ...
      <div
        onClick={() => {
          props.setconfirmVehiclePanel(true), props.selectVehicle("motorbike");
        }}
        className="active:outline-2 border-gray-50  w-full mt-5 rounded-2xl flex items-center"
      >
        <div>
          <img
            className="h-20 w-20 object-contain"
        ...
        <div className="px-4 mt-2">
          <h4 className="font-semibold">
            UberGo <i className="ri-user-fill"></i> 1
          </h4>
          <h6 className="text-sm">2 min away</h6>
          <h6 className="text-xs">affordable and compact rides</h6>
        </div>
      ...
      <div
        onClick={() => {
          props.setconfirmVehiclePanel(true), props.selectVehicle("auto");
        }}
        className="active:outline-2 border-gray-50  w-full mt-5 rounded-2xl flex items-center"
      >
        <div>
        ...
        <div className="px-4 mt-2">
          <h4 className="font-semibold">
            UberGo <i className="ri-user-fill"></i> 2
          </h4>
          <h6 className="text-sm">2 min away</h6>
          <h6 className="text-xs">affordable and compact rides</h6>
        </div>
